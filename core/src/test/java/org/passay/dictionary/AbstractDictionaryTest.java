...
public abstract class AbstractDictionaryTest
{
  ...
  {
    webFile = Dictionaries.WEB_FILE;
    webFileSorted = Dictionaries.WEB_FILE_SORTED;
    webFileLowerCase = Dictionaries.WEB_FILE_LOWERCASE;
    webFileLowerCaseSorted = Dictionaries.WEB_FILE_LOWERCASE_SORTED;
    fbsdFile = Dictionaries.FREEBSD_FILE;
    fbsdFileSorted = Dictionaries.FREEBSD_FILE_SORTED;
    fbsdFileLowerCase = Dictionaries.FREEBSD_FILE_LOWERCASE;
    fbsdFileLowerCaseSorted = Dictionaries.FREEBSD_FILE_LOWERCASE_SORTED;
